...
// Indices is a list of commit indices and the destination pull request index
type Indices struct {
...
// Evaluate evaluates the selector string and existing pull request sets and returns an Indicies
func Evaluate(commits []*internal.PRCommit, selector string) (Indices, error) {
